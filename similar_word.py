...
def main():
    ...
    for verb in verb2idx.keys():
        ...
        sims = glove_vectors.most_similar(verb, topn=10)  # get other similar word
        verb2sim_word[verb] = {sim: score for sim, score in sims}
    ...
    for obj in obj2idx.keys():
        obj = obj.split("_")[0]
        sims = glove_vectors.most_similar(obj, topn=10)  # get other similar word
        obj2sim_word[obj] = {sim: score for sim, score in sims}
