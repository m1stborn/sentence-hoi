...
class HoiTR(nn.Module):
    ...
    def __init__(self, backbone, transformer, num_classes, num_actions, num_queries, aux_loss=False, mode=""):
    ...
    def forward(self, outputs, targets):
        ...
        Parameters:
             ...
             targets: list of dicts, such that len(targets) == batch_size.
                    ...
                    dict structure: {
                        human_boxes : torch.Size([3, 4]) = [num_human, 4]
                        human_labels : torch.Size([3])
                        object_boxes : torch.Size([3, 4]) = [num_obj, 4]
                        object_labels : torch.Size([3])
                        action_boxes : torch.Size([3, 4]) = [num_interaction, 4]
                        action_labels : torch.Size([3])
                        org_size : torch.Size([2])
                    }
        """
